...
var _VirtualScroller = _interopRequireWildcard(require("./VirtualScroller"));
...
function (_React$Component) {
  ...
  _createClass(ReactVirtualScroller, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (items.length !== prevProps.items.length || !(0, _shallowEqual["default"])(prevProps.items, items) || Array.isArray(items[items.length - 1]) && (items[items.length - 1].length !== prevProps.items[prevProps.items.length - 1].length || !(0, _shallowEqual["default"])(prevProps.items, items))) {
    ...
    value: function render() {
      ...
      if (!this.itemsPropertyWasChanged) {
        this.itemsPropertyWasChanged = !(0, _shallowEqual["default"])(this.props.items, this.previousItemsProperty);
      }

      this.previousItemsProperty = this.props.items;

      if (this.itemsPropertyWasChanged && newItems !== previousItems) {
        var _getItemsDiff = (0, _VirtualScroller.getItemsDiff)(previousItems, newItems),
...
_defineProperty(ReactVirtualScroller, "propTypes", {
  as: elementType,
  items: _propTypes["default"].oneOfType([_propTypes["default"].arrayOf(_propTypes["default"].object).isRequired, _propTypes["default"].arrayOf(_propTypes["default"].array).isRequired]),
  ...
  initialState: _propTypes["default"].shape({
    ...
    afterItemsHeight: _propTypes["default"].number.isRequired,
    itemHeights: _propTypes["default"].arrayOf(_propTypes["default"].number).isRequired,
    itemSpacing: _propTypes["default"].number
  })
});
