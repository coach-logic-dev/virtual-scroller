...
exports.getItemsDiff = getItemsDiff;
...
var VirtualScroller = /*#__PURE__*/function () {
  ...
  function VirtualScroller(getContainerElement, items) {
    ...
    _defineProperty(this, "onResize", (0, _utility.debounce)(function (event) {
      ...
      if (action === "UPDATE_LAYOUT") {
        ...
        (0, _log["default"])("~ Scrollable container size changed, re-measure item heights. ~");
        _this.resized = true;
    ...
    _defineProperty(this, "didUpdateState", function (prevState) {
      ...
      if (_this.resized) {
        ...
        (0, _log["default"])("~ Rendered (resize) ~"); // Stop "multi-render layout" if it's in progress.
    ...
    _defineProperty(this, "updateShownItemIndexes", function () {
      ...
      (0, _log["default"])("Last shown item index", lastShownItemIndex);
      ...
      if ((0, _log.isDebug)()) {
        (0, _log["default"])("Item heights", _this.getState().itemHeights.slice());
        (0, _log["default"])("Item states", _this.getState().itemStates.slice());
      }
    ...
    _defineProperty(this, "restoreScroll", function () {
      ...
      if (scrollByY !== 0) {
        (0, _log["default"])("Restore scroll position: scroll by", scrollByY);
    ...
    _defineProperty(this, "onUpdateShownItemIndexes", function (_ref) {
      ...
      (0, _requestAnimationFrameTimeout.clearTimeout)(_this.onUserStopsScrollingTimeout); //
      ...
      if (reason === "scroll") {
        ...
        if (forceRender) {
          (0, _log["default"])("The user has scrolled far enough: force re-render");
        } else {
          (0, _log["default"])("The user hasn't scrolled too much: delay re-render");
        ...
        if (!forceRender) {
          return _this.onUserStopsScrollingTimeout = (0, _requestAnimationFrameTimeout.setTimeout)(_this.onUserStoppedScrolling, WAIT_FOR_USER_TO_STOP_SCROLLING_TIMEOUT);
        }
    ...
    var bypass = options.bypass,
        ...
        state = options.state;
    (0, _log["default"])("~ Initialize ~"); // If `state` is passed then use `items` from `state`
    ...
    if (scrollableContainer) {
      this.scrollableContainer = new _ScrollableContainer["default"](scrollableContainer);
    } else if (typeof window !== "undefined") {
      this.scrollableContainer = new _ScrollableContainer.ScrollableWindowContainer();
    } // if (margin === undefined) {
    ...
    if (tbody) {
      ...
      if (!(0, _tbody.supportsTbody)()) {
        (0, _log["default"])("~ <tbody/> not supported ~");
        (0, _tbody.reportTbodyIssue)();
        bypass = true;
      }
    }

    if (bypass) {
      (0, _log["default"])('~ "bypass" mode ~');
    ...
    if (setState) {
      ...
      this.setState = function (state) {
        ...
        var newState = _objectSpread(_objectSpread({}, prevState), state);
    ...
    if (state) {
      (0, _log["default"])("Initial state (passed)", state);
    ...
    if (getContainerElement()) {
      (0, _DOM.clearElement)(getContainerElement());
    }

    this.itemHeights = new _ItemHeights["default"](this.getContainerElement, this.getState);
    ...
    if (estimatedItemHeight) {
      (0, _log["default"])("Estimated item height", estimatedItemHeight);
    }
  }
  /**
  ...
  _createClass(VirtualScroller, [{
    ...
    value: function getInitialState(customState) {
      ...
      var state = _objectSpread(_objectSpread(_objectSpread({}, customState), this.getInitialLayoutState()), {}, {
      ...
      (0, _log["default"])("Last shown item index", state.lastShownItemIndex);
      return state;
    }
  }, {
    ...
    value: function listen() {
      ...
      (0, _log["default"])("~ Rendered (initial) ~"); // `this.isRendered = true` should be the first statement in this function,
    ...
    value: function stop() {
      ...
      if (!this.bypass) {
        ...
        (0, _requestAnimationFrameTimeout.clearTimeout)(this.onUserStopsScrollingTimeout);
        (0, _requestAnimationFrameTimeout.clearTimeout)(this.watchContainerElementCoordinatesTimer);
      }
    }
    /**
    ...
    value: function updateTbodyPadding() {
      ...
      (0, _tbody.setTbodyPadding)(this.getContainerElement(), beforeItemsHeight, afterItemsHeight);
    }
  }, {
    ...
    value: function updateItemHeights() {
      ...
      if (fromIndex !== undefined) {
        ...
        if ((0, _log.isDebug)()) {
          (0, _log["default"])("Item heights", this.getState().itemHeights.slice());
        }
      }
    }
  }, {
    ...
    value: function onItemStateChange(i, itemState) {
      if ((0, _log.isDebug)()) {
        (0, _log["default"])("~ Item state changed ~");
        (0, _log["default"])("Item", i);
        (0, _log["default"])("Previous state" + "\n" + JSON.stringify(this.getState().itemStates[i], null, 2));
        (0, _log["default"])("New state" + "\n" + JSON.stringify(itemState, null, 2));
      }
    ...
    value: function onItemHeightChange(i) {
      ...
      if (previousHeight !== newHeight) {
        (0, _log["default"])("~ Item height changed ~");
        (0, _log["default"])("Item", i);
        (0, _log["default"])("Previous height", previousHeight);
        (0, _log["default"])("New height", newHeight);
        this.onUpdateShownItemIndexes({
      ...
      while (i < this.getItemsCount()) {
        ...
        if (firstShownItemIndex === undefined) {
          if (listTopOffset + itemsHeight > visibleAreaTop) {
            (0, _log["default"])("First visible item index", i);
            firstShownItemIndex = i;
          }
        ...
        if (listTopOffset + itemsHeight > visibleAreaBottom) {
          (0, _log["default"])("Last visible item index", i); // The list height is estimated until all items have been seen,
    ...
    value: function watchContainerElementCoordinates() {
      ...
      var check = function check() {
        ...
        if (Date.now() - startedAt < WATCH_CONTAINER_ELEMENT_TOP_COORDINATE_MAX_DURATION) {
          _this2.watchContainerElementCoordinatesTimer = (0, _requestAnimationFrameTimeout.setTimeout)(check, WATCH_CONTAINER_ELEMENT_TOP_COORDINATE_INTERVAL);
        }
      }; // Run the cycle.
    ...
    value: function onMultiRenderLayoutRendered() {
      ...
      if (this.redoLayoutAfterRender) {
        ...
        return (0, _requestAnimationFrameTimeout.setTimeout)(function () {
    ...
    value: function setItems(newItems) {
      ...
      if (isIncrementalUpdate) {
        if (prependedItemsCount >= 0) {
          (0, _log["default"])("Prepend", prependedItemsCount, "items");
        ...
        if (appendedItemsCount >= 0) {
          (0, _log["default"])("Append", appendedItemsCount, "items");
        ...
        (0, _log["default"])("Items have changed, and it's not a simple append and/or prepend: rerender the entire list from scratch.");
        (0, _log["default"])("Previous items", previousItems);
...
function getItemsDiff(previousItems, newItems) {
